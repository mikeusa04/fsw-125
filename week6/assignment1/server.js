...
http://localhost:9000/inventoryItems/search/type?type=clothing to get the items for the type of clothing only
http://localhost:9000/inventoryItems/search/type?type=food to get the items for the type of food only
http://localhost:9000/inventoryItems/search/type?type=toy to get the items for the type of toy only
...
const thingFinder = require('./routes/thingFinder.js');
...
// routes
app.use("/inventoryItems", thingFinder);
